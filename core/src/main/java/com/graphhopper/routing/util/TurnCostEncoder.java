 ...
 *
 * int - the 32 bits are parted from left (high) to right (low) bits as
 * following: 4 bits - turn costs flags (e.g. fourth bit means 'restriction for
 * cars', third bit means 'restriction for bike', first and second bit are free
 * for later use) 14 bits - costs describing the time this turn would cost by
 * using a bike 14 bits - costs describing the time this turn would cost by
 * using a car
 *
 * @author Karl Hübner
 *
...
public final class TurnCostEncoder {
    ...
    /**
     * @return a new turn costs flag which holds a restriction for both car and
     * bike
     */
    ...
    /**
     * @return a new turn costs flag which holds the time this turn would cost
     * for car and bike
     */
     ...
     * @return <code>true</code> if this turn is restricted in both fastest and
     * shortest routing and for both cars and bikes
     */
