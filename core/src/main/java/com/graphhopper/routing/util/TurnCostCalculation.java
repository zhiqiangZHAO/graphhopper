...
/**
 * Calculates the turn costs for a given turn described by edgeFrom, viaNode and
 * edgeTo.
 *
 * @author Karl Hübner
 */
public interface TurnCostCalculation {
    ...
    /**
     * Gets the turn costs from
     * <code>fromEdge</code> via
     * <code>viaNode</code> to
     * <code>toEdge</code>
     *
     ...
     * @return the turn costs for this turn (to be encoded by
     * {@link TurnCostEncoder})
     */
