...
/**
 * An edge-based version of bidirectional Dijkstra. End link costs will be stored
 * for each edge instead of for each node. This is necessary when considering
 * turn costs, but will be slower than the classic version.
 * 
 * @see http://www.easts.info/on-line/journal_06/1426.pdf
 * 
 * TODO we better should reuse the code of DijkstraBidirectionRef instead instead of 
 * copying it. should be done later
 * 
 * @author Karl Hübner
 */
public class EdgeDijkstraBidirectionRef extends AbstractEdgeBasedRoutingAlgorithm {
    ...
    public EdgeDijkstraBidirectionRef(Graph graph, EdgePropertyEncoder encoder) {
        super(graph, encoder);
