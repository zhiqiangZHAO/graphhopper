...
{
    protected int visitedFromCount;
    protected int visitedToCount;
    ...
    protected abstract void checkState( int fromBase, int fromAdj, int toBase, int toAdj );

    protected abstract boolean fillEdgesFrom();

    protected abstract boolean fillEdgesTo();
